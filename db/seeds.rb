...
Service.create(:title => "Hair Cut", :category => 'hair_cut', :price => 49.99, :start_at => Time.now + 1.day, :end_at => Time.now + 1.day, :merchant_id => Merchant.last.id)
Service.create(:title => "Massage", :category => 'massage', :price => 49.99, :start_at => Time.now + 2.day, :end_at => Time.now + 2.day, :merchant_id => Merchant.last.id)
...
Service.create(:title => "Hair Style", :category => 'hair_style', :price => 49.99, :start_at => Time.now + 4.day, :end_at => Time.now + 4.day, :merchant_id => Merchant.last.id)
Service.create(:title => "Hair Cut", :category => 'hair_cut', :price => 49.99, :start_at => Time.now + 1.day, :end_at => Time.now + 1.day, :merchant_id => Merchant.last.id)
Service.create(:title => "Massage", :category => 'massage', :price => 49.99, :start_at => Time.now + 2.day, :end_at => Time.now + 2.day, :merchant_id => Merchant.last.id)
Service.create(:title => "Facial", :category => 'facial', :price => 49.99, :start_at => Time.now + 3.day, :end_at => Time.now + 3.day, :merchant_id => Merchant.last.id)
Service.create(:title => "Hair Style", :category => 'hair_style', :price => 49.99, :start_at => Time.now + 4.day, :end_at => Time.now + 4.day, :merchant_id => Merchant.last.id)
